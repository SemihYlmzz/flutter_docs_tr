  ...
  static List<DrawerItemModel> itemsList = [
    ...
    DrawerItemModel(
      ...
      items: [
        ...
        DrawerItemModel(
          ...
          items: [
            DrawerItemModel(
              itemText: 'Overview: Sound null safety',
              tier: 2,
            ),
      ...
      items: [
        ...
        DrawerItemModel(
          ...
          items: [
            ...
            DrawerItemModel(itemText: 'Package layout conventions', tier: 2),
      ...
      items: [
        ...
        DrawerItemModel(
          ...
          items: [
            ...
            DrawerItemModel(
              itemText: 'Objective-C and Swift interop',
              tier: 2,
            ),
        ...
        DrawerItemModel(
          ...
          items: [
            ...
            DrawerItemModel(
              itemText: 'Fetch data from the internet',
              tier: 2,
            ),
          ...
          items: [
            ...
            DrawerItemModel(
              ...
              items: [
                ...
                DrawerItemModel(
                  itemText: 'Add elements to the DOM',
                  tier: 3,
                ),
    ...
    DrawerItemModel(
      ...
      items: [
        ...
        DrawerItemModel(
          ...
          items: [
            DrawerItemModel(itemText: 'Customizing static analysis', tier: 2),
            DrawerItemModel(itemText: 'Fixing common type problems', tier: 2),
    ...
    DrawerItemModel(
      ...
      items: [
        ...
        DrawerItemModel(
          itemText: 'DartPad in tutorials: Best practices',
          tier: 1,
        ),
